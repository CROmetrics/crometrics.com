...
function twentyfourteen_paging_nav() {
	...
	<nav class="navigation paging-navigation" role="navigation">
		<h1 class="screen-reader-text cro-template-tags-1"><?php _e( 'Posts navigation', 'twentyfourteen' ); ?></h1>
...
function twentyfourteen_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		<h1 class="screen-reader-text cro-hide"><?php _e( 'Post navigation', 'twentyfourteen' ); ?></h1>
		<div class="nav-links">
			<?php
			if ( is_attachment() ) :
				previous_post_link( '%link', __( '<span class="meta-nav">Published In</span>%title', 'twentyfourteen' ) );
			else :
				previous_post_link( '%link', __( '<span class="meta-nav prev-nav">Previous Post</span>', 'twentyfourteen' ) );
				next_post_link( '%link', __( '<span class="meta-nav next-nav">Next Post</span>', 'twentyfourteen' ) );
			endif;
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
